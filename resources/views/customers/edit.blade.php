<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('customers.show', $customer) }}" class="text-sm text-gray-700 hover:text-gray-900">
                {{ __('Back to Customer') }}
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('customers.show', $customer) }}" class="text-sm text-gray-700 hover:text-gray-900">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
