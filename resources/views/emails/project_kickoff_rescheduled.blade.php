@php
    ...
    $previousAt = $previousScheduledAt?->format('Y-m-d H:i');
    $meetingLinkLabel = [
...
<head>
    <meta charset="UTF-8">
    <title>Kick-off Rescheduled</title>
</head>
                                ...
                                <tr>
                                    <td style="padding:18px 18px 6px 18px;">
                                        <div style="text-align:center;font-size:22px;font-weight:900;color:#0b1220;line-height:1.25;">
                                            Kick-off Rescheduled: {{ $project->name }}
                                        </div>
                                        ...
                                        <div style="margin:14px auto 0 auto;width:92%;max-width:520px;background:#f1f7ff;border:1px solid #dbeafe;border-radius:14px;padding:12px 14px;">
                                            <div style="text-align:center;color:#1f2a44;font-size:14px;line-height:1.5;">
                                                ...
                                                Please find the updated kick-off details below.
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:18px 18px 0 18px;">
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;border-spacing:0 10px;">
                                            @if ($previousAt)
                                                <tr>
                                                    <td style="background:#fef9c3;border:1px solid #fde68a;border-radius:14px;padding:14px 14px;">
                                                        <div style="font-size:12px;letter-spacing:0.4px;text-transform:uppercase;color:#92400e;font-weight:900;">
                                                            Previous Date &amp; Time
                                                        </div>
                                                        <div style="margin-top:6px;font-size:16px;font-weight:800;color:#7c2d12;">
                                                            {{ $previousAt }}
                                                        </div>
                                                    </td>
                                                </tr>
